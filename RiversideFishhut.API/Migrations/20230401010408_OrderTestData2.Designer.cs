...
namespace RiversideFishhut.API.Migrations
{
    ...
    [Migration("20230401010408_OrderTestData2")]
    partial class OrderTestData2
    {
            ...
            modelBuilder.Entity("RiversideFishhut.API.Data.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 31, 21, 4, 7, 709, DateTimeKind.Local).AddTicks(4556),
                            OrderStatusId = 1,
                            OrderTypeId = 1,
                            PaymentStatus = false,
                            StaffId = 1,
                        ...
                        new
                        {
                            OrderId = 2,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 31, 21, 4, 7, 709, DateTimeKind.Local).AddTicks(4583),
                            OrderStatusId = 3,
                            OrderTypeId = 2,
                            PaymentStatus = true,
                            StaffId = 2,
                        ...
                        new
                        {
                            OrderId = 3,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 31, 21, 4, 7, 709, DateTimeKind.Local).AddTicks(4584),
                            OrderStatusId = 2,
                            OrderTypeId = 1,
                            PaymentStatus = false,
                            StaffId = 1,
                        ...
                        new
                        {
                            OrderId = 4,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 31, 21, 4, 7, 709, DateTimeKind.Local).AddTicks(4586),
                            OrderStatusId = 1,
                            OrderTypeId = 1,
                            PaymentStatus = false,
                            StaffId = 1,
                        ...
                        new
                        {
                            OrderId = 5,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 31, 21, 4, 7, 709, DateTimeKind.Local).AddTicks(4588),
                            OrderStatusId = 1,
                            OrderTypeId = 1,
                            PaymentStatus = false,
                            StaffId = 1,
                        ...
                        new
                        {
                            OrderId = 6,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 29, 21, 4, 7, 709, DateTimeKind.Local).AddTicks(4590),
                            OrderStatusId = 2,
                            OrderTypeId = 3,
                            PaymentStatus = true,
                            StaffId = 2,
