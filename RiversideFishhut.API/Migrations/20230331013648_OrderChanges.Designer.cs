...
namespace RiversideFishhut.API.Migrations
{
    ...
    [Migration("20230331013648_OrderChanges")]
            ...
            modelBuilder.Entity("RiversideFishhut.API.Data.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 30, 21, 36, 48, 297, DateTimeKind.Local).AddTicks(7647),
                            OrderStatusId = 1,
                            OrderTypeId = 1,
                            PaymentStatus = false,
                            StaffId = 1,
                        ...
                        new
                        {
                            OrderId = 2,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 30, 21, 36, 48, 297, DateTimeKind.Local).AddTicks(7674),
                            OrderStatusId = 4,
                            OrderTypeId = 2,
                            PaymentStatus = true,
                            StaffId = 2,
                        ...
                        new
                        {
                            OrderId = 3,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 30, 21, 36, 48, 297, DateTimeKind.Local).AddTicks(7675),
                            OrderStatusId = 2,
                            OrderTypeId = 1,
                            PaymentStatus = false,
                            StaffId = 1,
                        ...
                        new
                        {
                            OrderId = 4,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 30, 21, 36, 48, 297, DateTimeKind.Local).AddTicks(7677),
                            OrderStatusId = 1,
                            OrderTypeId = 1,
                            PaymentStatus = false,
                            StaffId = 1,
                        ...
                        new
                        {
                            OrderId = 5,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 30, 21, 36, 48, 297, DateTimeKind.Local).AddTicks(7678),
                            OrderStatusId = 1,
                            OrderTypeId = 1,
                            PaymentStatus = false,
                            StaffId = 1,
                        ...
                        new
                        {
                            OrderId = 6,
                            BeforeTax = 0m,
                            OrderDate = new DateTime(2023, 3, 30, 21, 36, 48, 297, DateTimeKind.Local).AddTicks(7680),
                            OrderStatusId = 2,
                            OrderTypeId = 3,
                            PaymentStatus = true,
                            StaffId = 2,
